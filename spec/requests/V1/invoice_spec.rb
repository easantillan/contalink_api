...
RSpec.describe V1::InvoicesController, type: :request do
  describe "GET /index" do
    ...
    before(:all) do
      ...
      # this one is for ensure test for date range
      create(:invoice, invoice_date: "2020-01-01")
    end
    ...
    describe "GET /V1/invoices" do
      ...
      it "returns a list of 15 invoces for the 1st page" do
        get "/V1/invoices"
        json_response = JSON.parse(response.body)
        expect(json_response["invoices"].count).to eq(15)
      end

      it "returns a list of 15 invoces for the 2nd page" do
      ...
      it "returns a list of invoices for datas between 2020-01-01 and 2020-12-31" do
        ...
        json_response["invoices"].each do |invoice|
          invoice_date = DateTime.strptime(invoice["invoiceDate"], "%m/%d/%Y %I:%M %p").to_date
